...
面向手机的中文运动计划与打卡 Web App。当前核心版本包括邮箱注册/登录、资料初始化、自定义周期计划、未来 90 天日程、一键打卡、撤销、日历、统计、个人设置和可安装 PWA。Web 端只负责计划和记录，不包含“打开视频”或外部视频链接。
...
当前提交是运动计划/记录核心。好友关系、动态流、体重趋势、打卡照片和推送发送服务不在本轮核心内；不得用空页面或虚假数据冒充这些能力。
